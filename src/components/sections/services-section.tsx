    ...
    <section id="capabilities" className="py-20 md:py-32 bg-card">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight font-headline">The Studio in One</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                    <Clapperboard className="w-8 h-8 text-accent" />
                    <h3 className="text-2xl font-bold font-headline">Film & Visual Storytelling</h3>
                </div>
             ...
             <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-2xl font-bold font-headline">Design & Motion</h3>
                </div>
                <ul className="space-y-2 text-foreground/80 font-serif">
             ...
             <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-2xl font-bold font-headline">Digital & Interactive</h3>
                </div>
                <ul className="space-y-2 text-foreground/80 font-serif">
        ...
        <p className="text-center mt-16 text-xl font-semibold text-foreground/90 font-serif">
