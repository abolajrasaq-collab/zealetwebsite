...
const testimonials = [
  {
    ...
    logo: 'https://picsum.photos/100/100?random=t1',
  ...
  },
  {
    ...
    logo: 'https://picsum.photos/100/100?random=t2',
    aiHint: 'man portrait',
  },
  {
    name: 'TechFront',
    ...
    logo: 'https://picsum.photos/100/100?random=t3',
    aiHint: 'office team',
  },
];

const clientLogos = [
    { name: 'Client 1', logo: 'https://picsum.photos/120/40?random=c1', aiHint: 'minimalist logo' },
    { name: 'Client 2', logo: 'https://picsum.photos/120/40?random=c2', aiHint: 'abstract logo' },
    { name: 'Client 3', logo: 'https://picsum.photos/120/40?random=c3', aiHint: 'geometric logo' },
    { name: 'Client 4', logo: 'https://picsum.photos/120/40?random=c4', aiHint: 'tech logo' },
    { name: 'Client 5', logo: 'https://picsum.photos/120/40?random=c5', aiHint: 'creative logo' },
    { name: 'Client 6', logo: 'https://picsum.photos/120/40?random=c6', aiHint: 'bold logo' },
];
